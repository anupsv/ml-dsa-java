...
import io.salvador.mldsa.api.*;
import io.salvador.mldsa.params.Parameters;
import io.salvador.mldsa.poly.*;
import io.salvador.mldsa.ntt.*;
...
public class DebugTest {
    ...
    void debugSigning() {
        ...
        Object[] skParts = io.salvador.mldsa.encode.ByteCodec.decodePrivateKey(
        ...
        var y = io.salvador.mldsa.sampling.Sampler.sampleMask(params, rhoPrime, 0);
        ...
        Polynomial c = io.salvador.mldsa.sampling.Sampler.sampleInBall(params, cSeed);
        int cNonzeros = 0;
        for (int i = 0; i < 256; i++) {
